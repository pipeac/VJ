...
enum PlayerAnims
{
	STAND_LEFT, STAND_RIGHT, MOVE_LEFT, MOVE_RIGHT, VINE_LEFT, VINE_RIGHT, VINE_STAND_LEFT, VINE_STAND_RIGHT, JUMP_LEFT, JUMP_RIGHT, DIE, CROUCH
};
...
void Player::init(const glm::ivec2 &tileMapPos, ShaderProgram &shaderProgram)
{
	...
	sprite->setNumberAnimations(12);
		...
		sprite->addKeyframe(CROUCH, glm::vec2(0.75f, 0.25f));
